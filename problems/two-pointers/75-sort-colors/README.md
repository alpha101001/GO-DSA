...
[View the problem on LeetCode](https://leetcode.com/problems/sort-colors/description/)
...
|---|---|---|---|
| Example 1 | `sortColors([]int{2, 0, 2, 1, 1, 0})` | `[]int{0, 0, 1, 1, 2, 2}` |  |
| Example 2 | `sortColors([]int{2, 0, 1})` | `[]int{0, 1, 2}` |  |
...
```bash
go run ./problems/75-sort-colors
```
